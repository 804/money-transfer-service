...
/**
 * Exception mapper for converting thrown {@link NoSuchMoneyException}
 * to error response with 400 HTTP code.
 *
 * @author Evgeny Zubenko
 */
public class NoSuchMoneyExceptionMapper implements ExceptionMapper<NoSuchMoneyException> {
    @Override
    public Response toResponse(NoSuchMoneyException exception) {
